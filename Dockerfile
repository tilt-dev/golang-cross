...
# TODO Go 1.14 supports macOS 10.11 (el capitan) and higher. Update this to 10.11 SDK
...
# TODO Go 1.1 4supports macOS 10.11 (el capitan) and higher. Update this to 10.11
# once an updated version of the SDK is available on s3.dockerproject.org
